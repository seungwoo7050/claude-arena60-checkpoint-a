...
| 파라미터 | 후보 1 | 후보 2 | 후보 3 | 최종 | 이유 |
|---------|--------|--------|--------|------|------|
| 발사체 속도 | 20 m/s | **30 m/s** ✅ | 50 m/s | 30 m/s | 너무 느리면 회피 쉬움, 너무 빠르면 반응 불가 |
| 충돌 반지름 | 0.1 m | **0.2 m** ✅ | 0.5 m | 0.2 m | 플레이어(0.5m)의 40%, 적절한 히트박스 |
| 발사 쿨다운 | 0.05s (20/s) | **0.1s (10/s)** ✅ | 0.2s (5/s) | 0.1s | spam 방지 + 조준 중요성 |
| 피해량 | 10 HP (10발 킬) | **20 HP (5발 킬)** ✅ | 33 HP (3발 킬) | 20 HP | 교전 시간 5초 적정 |
| 발사체 수명 | 1.0s | **1.5s** ✅ | 2.0s | 1.5s | 30m/s × 1.5s = 45m 사거리 |
